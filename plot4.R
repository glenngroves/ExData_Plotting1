...
# Step 5 - set up to produce the four separate plots within one plot/output
png(filename = "plot4.png")
par(mfrow = c(2,2))

# Step 6 - Output plot in top left corner
plot(feb_data$Global_active_power, type="l", xaxt="n", xlab = "", ylab="Global Active Power")
axis(side=1,at=c(1,1440,2880),labels=c("Thu","Fri", "Sat"))

# Step 7 - Output plot in top right corner
plot(feb_data$Voltage, type="l", xaxt="n", xlab = "datetime", ylab="Voltage")
axis(side=1,at=c(1,1440,2880),labels=c("Thu","Fri", "Sat"))

# Step 8 - Output plot in lower left corner
...
# Step 9 - Output plot in lower right corner
plot(feb_data$Global_reactive_power, type="l", xaxt="n", xlab = "datetime", ylab="Global_reactive_power")
axis(side=1,at=c(1,1440,2880),labels=c("Thu","Fri", "Sat"))
